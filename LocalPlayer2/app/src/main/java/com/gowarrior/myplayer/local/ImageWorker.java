...
public class ImageWorker {
	...
	public void loadImage(Object data, FILETYPE type, ImageView imageView) {
        ...
        Log.d(TAG, "try to load image:" + data);
		if (cancelPotentialWork(data, imageView)) {
            Log.d(TAG, "try to new worker task");
	...
	private Bitmap processBitmap(Object data) {	
        ...
        Log.d(TAG, "process bitmap,path=" + path);
	...
	private Bitmap decodeFile(File f) {
		try {
		    ...
		    try {
                ...
                Log.d(TAG, "bad getErrorInfoFromException");
            }		    
		}
		return null;
	}
	...
	private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
		...
		protected Bitmap doInBackground(Object... params) {
			Log.d(TAG, "doInBackground - starting work,params[0]=" + params[0] + ",param[1](FILETYPE)=" + params[1]);
