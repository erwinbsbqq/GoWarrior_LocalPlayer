...
public class MediaPlayerActivity extends Activity implements
        AbsMediaPlayer.OnCompletionListener, AbsMediaPlayer.OnErrorListener, AbsMediaPlayer.OnInfoListener,
        AbsMediaPlayer.OnBufferingUpdateListener, AbsMediaPlayer.OnPreparedListener, AbsMediaPlayer.OnSeekCompleteListener,
        AbsMediaPlayer.OnVideoSizeChangedListener, SurfaceHolder.Callback,
        MediaPlaybar.MediaPlayerControl, AbsMediaPlayer.OnTimedTextListener {
    ...
    private boolean mIsStarted = false;//for get current time or duration
    private boolean mIsStoped = true;//for stop or not
    ...
    // // Get video size
    // if (mPlayer == null) {
    // Log.v(LOGTAG, "MediaPlayer is null!");
    // return;
    // }
    // int videoWidth = mPlayer.getVideoWidth();
    // int videoHeight = mPlayer.getVideoHeight();
    ...
    // Log.i(LOGTAG, "SurfaceView Rect = " + rect.toString());
    // }
    //
    // Log.i(LOGTAG, "change ratio to " + ratio);
    // if (videoWidth <= 0 || videoHeight <= 0) {
    // Log.e(LOGTAG, "Invalid video size, width: "
    ...
    // } else {
    // Log.e(LOGTAG, "invalid surface view");
    // return;
    // }
    //
    // switch (ratio) {
    ...
    // double art = (double) videoWidth / (double) videoHeight;
    // if (art > ard) {
    // displayHeight = displayWidth * videoHeight / videoWidth;
    // }
    // }
    ...
    // break;
    // }
    // // Log.i(LOGTAG, "Source w: " + videoWidth + ", h: " + videoHeight);
    // // Log.i(LOGTAG, "Target w: " + displayWidth + ", h: " + displayHeight);
